...
RSpec.describe Packages::ReportsController do
  ...
  it { expect(delete: "/paquets/9c6c00c4-0784-4ef8-8978-b1e0246882a7/signalements").to be_unroutable }
  ...
  it { expect(get:    "/paquets/9c6c00c4-0784-4ef8-8978-b1e0246882a7/signalements/remove").to    be_unroutable }
  it { expect(get:    "/paquets/9c6c00c4-0784-4ef8-8978-b1e0246882a7/signalements/undiscard").to be_unroutable }
  it { expect(patch:  "/paquets/9c6c00c4-0784-4ef8-8978-b1e0246882a7/signalements/undiscard").to be_unroutable }
