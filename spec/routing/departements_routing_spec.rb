...
RSpec.describe DepartementsController do
  ...
  it { expect(get:    "/departements/remove").to    route_to("departements#show", id: "remove") }
  it { expect(get:    "/departements/undiscard").to route_to("departements#show", id: "undiscard") }
  it { expect(patch:  "/departements/undiscard").to route_to("departements#update", id: "undiscard") }
  ...
  it { expect(get:    "/departements/9c6c00c4-0784-4ef8-8978-b1e0246882a7/remove").not_to    be_routable }
  it { expect(get:    "/departements/9c6c00c4-0784-4ef8-8978-b1e0246882a7/undiscard").not_to be_routable }
  it { expect(patch:  "/departements/9c6c00c4-0784-4ef8-8978-b1e0246882a7/undiscard").not_to be_routable }
end
