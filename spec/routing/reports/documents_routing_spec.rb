...
RSpec.describe Reports::DocumentsController do
  ...
  it { expect(get:    "/signalements/9c6c00c4/documents/b12170f4").to route_to("reports/documents#show", report_id: "9c6c00c4", id: "b12170f4") }
  ...
  it { expect(get:    "/signalements/9c6c00c4/documents/b12170f4/file.pdf").to  route_to("reports/documents#show", report_id: "9c6c00c4", id: "b12170f4", filename: "file.pdf") }
  it { expect(get:    "/signalements/9c6c00c4/documents/b12170f4/image.png").to route_to("reports/documents#show", report_id: "9c6c00c4", id: "b12170f4", filename: "image.png") }
end
