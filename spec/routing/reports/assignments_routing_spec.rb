...
RSpec.describe Reports::AssignmentsController do
  it { expect(get:    "/signalements/9c6c00c4/assign").to be_unroutable }
  ...
  it { expect(get:    "/signalements/9c6c00c4/assign/edit").to      route_to("reports/assignments#edit", report_id: "9c6c00c4") }
