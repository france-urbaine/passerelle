...
RSpec.describe Reports::DenialsController do
  it { expect(get:    "/signalements/9c6c00c4/deny").to route_to("reports/denials#edit", report_id: "9c6c00c4") }
  ...
  it { expect(get:    "/signalements/9c6c00c4/deny/edit").to      be_unroutable }
