...
RSpec.describe PublishersController do
  ...
  it { expect(post:   "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  ...
  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/undiscard").to be_unroutable }
