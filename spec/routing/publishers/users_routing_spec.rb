...
RSpec.describe "Users nested under publishers" do
  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("users#index", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(post:   "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("users#create", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(patch:  "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to be_unroutable }
  it { expect(delete: "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("users#destroy_all", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }

  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/new").to       route_to("users#new", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/edit").to      be_unroutable }
  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/remove").to    route_to("users#remove_all", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(get:    "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/undiscard").to be_unroutable }
  it { expect(patch:  "/editeurs/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/undiscard").to route_to("users#undiscard_all", publisher_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
