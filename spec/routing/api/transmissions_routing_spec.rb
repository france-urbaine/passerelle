...
RSpec.describe API::TransmissionsController do
  ...
  it { expect(get:    "/api/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(post:   "/api/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(delete: "/api/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(put:    "/api/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  ...
  it { expect(get:    "/api/transmissions/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(post:   "/api/transmissions/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(delete: "/api/transmissions/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
  it { expect(put:    "/api/transmissions/9c6c00c4-0784-4ef8-8978-b1e0246882a7").to be_unroutable }
end
