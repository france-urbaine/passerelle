...
RSpec.describe CollectivitiesController do
  ...
  it { expect(get:    "/collectivites/undiscard").to  route_to("collectivities#show", id: "undiscard") }
  ...
  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/undiscard").not_to be_routable }
