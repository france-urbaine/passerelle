...
RSpec.describe Collectivities::UsersController do
  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("collectivities/users#index", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(post:   "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("collectivities/users#create", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(patch:  "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to be_unroutable }
  it { expect(delete: "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs").to route_to("collectivities/users#destroy_all", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }

  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/new").to       route_to("collectivities/users#new", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/edit").to      be_unroutable }
  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/remove").to    route_to("collectivities/users#remove_all", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
  it { expect(get:    "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/undiscard").to be_unroutable }
  it { expect(patch:  "/collectivites/9c6c00c4-0784-4ef8-8978-b1e0246882a7/utilisateurs/undiscard").to route_to("collectivities/users#undiscard_all", collectivity_id: "9c6c00c4-0784-4ef8-8978-b1e0246882a7") }
