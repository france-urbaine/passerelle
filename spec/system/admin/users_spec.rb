...
RSpec.describe "Users in admin" do
  ...
  it "selects and discards all users from the current page on index page & rollbacks" do
    ...
    #
    create_list(:user, 7, :using_existing_organizations, created_at: 2.days.from_now)
  ...
  it "selects and discards all users through several pages on index page & rollbacks" do
    ...
    #
    create_list(:user, 8, :using_existing_organizations)
    ...
    #
    within ".datatable__selection", text: "10 utilisateurs sélectionnés" do
      click_on "Sélectionner les 20 utilisateurs des 2 pages"
    end

    within ".datatable__selection", text: "20 utilisateurs sélectionnés" do
      click_on "Tout supprimer"
    end

    # A confirmation dialog should appear
    #
    within "[role=dialog]", text: "Êtes-vous sûrs de vouloir supprimer les 20 utilisateurs sélectionnés ?" do
      click_on "Continuer"
    end
    ...
    click_on "Masquer cette notification"
    ...
    click_on "Options d'affichage"
    click_on "Afficher 10 lignes par page"
    click_on "Afficher 50 lignes"
