...
RSpec.describe "Managing DDFIP users" do
  ...
  it "visits an user page from the DDFIP page" do
    ...
    # The browser should have redirect back to DDFIP page
    #
  ...
  it "invites an user from the DDFIP page" do
    ...
    # The browser should stay on DDFIP page
    ...
    expect(page).to have_selector(
      :table_row,
      "Utilisateur" => "Elliot Alderson",
      "Guichets"    => "PELP de Bayonne et PELH de Bayonne"
    )
  ...
  it "updates an user from the DDFIP page" do
    ...
    #
    within :table_row, {
      "Utilisateur" => "Maxime Gauthier",
      "Guichets"    => "PELP de Bayonne"
    } do
  ...
  it "discards an user from the DDFIP page and then rollbacks" do
    visit ddfip_path(ddfip64)
  ...
  it "selects and discards one user from the DDFIP page and then rollbacks" do
    visit ddfip_path(ddfip64)
  ...
  it "selects and discards all users from the current page on the DDFIP page and then rollbacks" do
  ...
  it "selects and discards all users through several pages on the DDFIP page and then rollbacks" do
    # Create a bunch of users to have several pages
    # Also create discarded users on other organizations to ensure there are not rollbacked
    #
    create_list(:user, 10, organization: ddfip64)
