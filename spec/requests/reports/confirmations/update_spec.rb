...
RSpec.describe "Reports::ConfirmationsController#update" do
  subject(:request) do
    patch "/signalements/confirm/#{report.id}", as:, headers:, params:
  end
  ...
  describe "responses" do
    ...
    context "when report is already canceled" do
      let!(:report) { create(:report, :canceled_by_ddfip) }
