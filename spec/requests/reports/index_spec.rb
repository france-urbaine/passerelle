    ...
    context "when signed in as a DDFIP user" do
      ...
      let(:reports) do
        ...
        [
          ...
          create(:report, :package_assigned_by_ddfip, **attributes, package_sandbox: true),
          create(:report, :package_assigned_by_ddfip, **attributes),
          create(:report, :package_assigned_by_ddfip, **attributes, collectivity: collectivities[1]),
          create(:report, :package_assigned_by_ddfip, **attributes, form_type: "evaluation_local_professionnel")
        ]
      end
