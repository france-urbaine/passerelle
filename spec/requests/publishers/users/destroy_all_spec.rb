...
RSpec.describe "Publishers::UsersController#destroy_all" do
  subject(:request) do
    delete "/editeurs/#{publisher.id}/utilisateurs", as:, headers:, params:
  end
    ...
    context "with multiple ids" do
      ...
      it "sets a flash action to cancel" do
        expect(flash).to have_flash_actions.to include(
          label:  "Annuler",
          method: "patch",
          url:    "/editeurs/#{publisher.id}/utilisateurs/undiscard",
          params: { ids: ids }
        )
      end
    end
