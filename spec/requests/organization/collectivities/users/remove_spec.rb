...
RSpec.describe "Organization::Collectivities::UsersController#remove" do
  subject(:request) do
    get "/organisation/collectivites/#{collectivity.id}/utilisateurs/#{user.id}/remove", as:, headers:, params:
  end
