...
RSpec.describe "Organization::Collectivities::Users::ResetsController#new" do
  subject(:request) do
    get "/organisation/collectivites/#{collectivity.id}/utilisateurs/#{user.id}/reset/new", as:, headers:, params:
  end
