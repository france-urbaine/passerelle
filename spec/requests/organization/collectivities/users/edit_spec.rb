...
RSpec.describe "Organization::Collectivities::UsersController#edit" do
  subject(:request) do
    get "/organisation/collectivites/#{collectivity.id}/utilisateurs/#{user.id}/edit", as:, headers:, params:
  end
