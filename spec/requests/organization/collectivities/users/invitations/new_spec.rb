...
RSpec.describe "Organization::Collectivities::Users::InvitationsController#new" do
  subject(:request) do
    get "/organisation/collectivites/#{collectivity.id}/utilisateurs/#{user.id}/invitation/new", as:, headers:, params:
  end
