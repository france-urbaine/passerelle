...
RSpec.describe "Organization::OfficesController#update" do
  subject(:request) do
    patch "/organisation/guichets/#{office.id}", as:, headers:, params:
  end
  ...
  describe "responses" do
    ...
    context "when assigning another DDFIP in attributes" do
      ...
      it "ignores the attributes to assign the DDIP from the URL" do
        expect { request and office.reload }
          .not_to change(office, :ddfip)
      end
    end
