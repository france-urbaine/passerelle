...
RSpec.describe "Organization::OauthApplications::AuditsController#index" do
  subject(:request) do
    get "/organisation/oauth_applications/#{oauth_application.id}/audits", as:, headers:, params:
  end
