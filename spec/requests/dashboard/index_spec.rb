...
RSpec.describe "DashboardsController#index" do
  ...
  describe "responses" do
    ...
    context "when signed in as a DDFIP user" do
      ...
      let(:included_reports) { create_list(:report, 1, :package_assigned_to_office, ddfip: ddfip) }
      let(:excluded_reports) do
        [
          create(:report, :package_assigned_to_office, :approved, ddfip: ddfip, commune: included_reports.first.commune, office: included_reports.first.commune.offices.first),
          create(:report, :package_assigned_to_office, :sandbox, ddfip: ddfip, commune: included_reports.first.commune, office: included_reports.first.commune.offices.first),
          create(:report, :package_assigned_to_office, :rejected, ddfip: ddfip, commune: included_reports.first.commune, office: included_reports.first.commune.offices.first),
          create(:report, :package_assigned_to_office, :debated, ddfip: ddfip, commune: included_reports.first.commune, office: included_reports.first.commune.offices.first),
          create(:report, :package_assigned_to_office, :discarded, ddfip: ddfip, commune: included_reports.first.commune, office: included_reports.first.commune.offices.first)
        ]
      end
    ...
    context "when signed in as a DDFIP admin" do
      let(:ddfip)           { create(:ddfip) }
      let(:included_report) { create(:report, :package_assigned_to_office, ddfip: ddfip) }
      let(:excluded_report) { create(:report, :package_assigned_to_office, :approved, ddfip: ddfip, commune: included_report.commune, office: included_report.commune.offices.first) }
