...
RSpec.describe "Admin::OfficesController#undiscard" do
  subject(:request) do
    patch "/admin/guichets/#{office.id}/undiscard", as:, headers:, params:
  end
    ...
    context "when the office is discarded" do
      ...
      it "sets a flash notice" do
        expect(flash).to have_flash_notice.to eq(
          scheme: "done",
          icon:   "arrow-path",
          header: "La suppression du guichet a été annulée.",
          delay:   3000
        )
      end
    end
