...
RSpec.describe "Admin::Collectivities::UsersController#undiscard_all" do
  subject(:request) do
    patch "/admin/collectivites/#{collectivity.id}/utilisateurs/undiscard", as:, headers:, params:
  end
