...
RSpec.describe "Admin::CollectivitiesController#index" do
  subject(:request) do
    get "/admin/collectivites", as:, headers:, params:, xhr:
  end
    ...
    context "when requesting HTML" do
      ...
      it "returns only kept collectivities" do
        aggregate_failures do
          ...
          expect(response).to have_html_body.to have_no_text(collectivities[1].name)
