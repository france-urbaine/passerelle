...
RSpec.describe "Admin::DDFIPs::OfficesController#undiscard_all" do
  subject(:request) do
    patch "/admin/ddfips/#{ddfip.id}/guichets/undiscard", as:, headers:, params:
  end
  ...
  describe "responses" do
    ...
    context "with ids from already undiscarded offices" do
