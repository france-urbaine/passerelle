...
RSpec.describe "Admin::DDFIPs::OfficesController#destroy_all" do
  subject(:request) do
    delete "/admin/ddfips/#{ddfip.id}/guichets", as:, headers:, params:
  end
    ...
    context "with multiple ids" do
      ...
      it "sets a flash notice" do
        expect(flash).to have_flash_notice.to eq(
          scheme: "success",
          header: "Les guichets sélectionnés ont été supprimés.",
      ...
      it "sets a flash action to cancel" do
        expect(flash).to have_flash_actions.to include(
          label:  "Annuler",
          method: "patch",
          url:    "/admin/ddfips/#{ddfip.id}/guichets/undiscard",
          params: { ids: ids }
        )
      end
    end
