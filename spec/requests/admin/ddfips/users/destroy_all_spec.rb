...
RSpec.describe "Admin::DDFIPs::UsersController#destroy_all" do
  subject(:request) do
    delete "/admin/ddfips/#{ddfip.id}/utilisateurs", as:, headers:, params:
  end
  ...
  describe "responses" do
    # Log in as a Publisher to avoid randomly creating another DDFIP
    ...
    context "with multiple ids" do
      ...
      it "sets a flash action to cancel" do
        expect(flash).to have_flash_actions.to include(
          label:  "Annuler",
          method: "patch",
          url:    "/admin/ddfips/#{ddfip.id}/utilisateurs/undiscard",
          params: { ids: ids }
        )
      end
    end
