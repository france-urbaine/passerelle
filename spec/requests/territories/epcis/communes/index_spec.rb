...
RSpec.describe "Territories::EPCIs::Communes#index" do
  subject(:request) do
    get "/territoires/epcis/#{epci.id}/communes", as:, headers:, params:, xhr:
  end
  ...
  let!(:communes) { create_list(:commune, 2, epci: epci) }
  ...
  describe "responses" do
    ...
    context "when requesting HTML" do
      context "when the publisher is accessible" do
        ...
        it { expect(response).to redirect_to("/territoires/epcis/#{epci.id}") }
      end
    end
