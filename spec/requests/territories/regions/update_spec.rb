...
RSpec.describe "Territories::RegionsController#update" do
  subject(:request) do
    patch "/territoires/regions/#{region.id}", as:, headers:, params:
  end
  ...
  describe "responses" do
    ...
    context "with valid attributes" do
      ...
      it { expect(response).to redirect_to("/territoires/regions") }
