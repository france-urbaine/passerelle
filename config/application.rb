...
module Passerelle
  class Application < Rails::Application
    ...
    DEFAULT_COMMUNES_URL = "https://www.insee.fr/fr/statistiques/fichier/7671844/table-appartenance-geo-communes-2026.zip"
    DEFAULT_EPCIS_URL    = "https://www.insee.fr/fr/statistiques/fichier/2510634/epci_au_01-01-2026.zip"
  end
end
