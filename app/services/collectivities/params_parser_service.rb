...
# Collectivities::ParamsParserService is a service to parse parameters passed to
...
#   - Region#codre_region
#
#   Collectivities::ParamsParserService.new(
...
#
#   > Collectivities::ParamsParserService.new(input).parse
